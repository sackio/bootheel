  ...
  var _$ = function(options){
    ...
    B['vw'] = function(options){
      ...
      self.set = function(key, val){
        ...
        var _s = Belt.get(this.setters, key)
          , _g = _.isFunction(_s) ? _s.call(this, val) : Belt.set(this, _s, val);
      ...
      self.get = function(key){
        ...
        var _s = Belt.get(this.getters, key);
    ...
    B['vwArray'] = function(options){
      ...
      _o = Belt.extend({
        'add': function(obj, opts){
          ...
          nv[_o.index] = new APP.Views.Location.Edit(_o);
          nv[_o.index].set(obj);
