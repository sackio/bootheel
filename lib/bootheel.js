...
(function(){
  ...
  var _$ = function(options){
    ...
    B['vw'] = function(options){
      ...
      if (self.set) self.setters['*'] = self.set;
      if (self.get) self.getters['*'] = self.get;
      ...
      self.get = function(key){
        ...
        var _s = Belt.get(this.getters, key)
          , _g = _.isFunction(_s) ? _s.call(this) : Belt.chain.apply(Belt, [this].concat(Belt.toArray(_s)));
      ...
      self.getAll = function(omit){
        var _t = this
          , _g = _.omit(_t.getters, omit ? Belt.toArray(omit) : []);
        return _.object(
          _.keys(_g)
