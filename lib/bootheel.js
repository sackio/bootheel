  ...
  var _$ = function(options){
    ...
    B['vw'] = function(options){
      ...
      self.set = function(key, val){
        ...
        if (!Belt.isPlainObj(_s)) _s = {'*': _s};
        _.each(_s, function(v, k){ return Belt.chain(_t, v, val); });
      ...
      self.get = function(key){
        ...
        if (!_.isObject(_s)){
          _g = Belt.chain(_t, _s);
        } else if (_.isArray(_s)) {
          _g = _.map(_s, function(v){ return Belt.chain(_t, v); });
        } else {
          _g = _.object(_.keys(_s), _.map(_s, function(v){ return Belt.chain(_t, v); }));
        }

        self.emit('get', key, _g);
        return _g;
      };
