...
(function(){
  ...
  var _$ = function(){
    ...
    B['mutableControl'] = function(options){
      ...
      o.settings = _.defaults(Belt.extend({}, _.pick(o, ['default_control', 'control_type', 'types', 'control_settings', 'schema'])
      , o.settings), {
      ...
      o = _.defaults(o, {
        'views': {
          'control': B[o.settings.control_type](Belt.extend({}
                     , _.pick(o, ['name', 'value', 'removable']), o.settings.control_settings || {}, o.control_settings || {}))
        }
      , 'events': {
        }
      , 'set': {
    ...
    B['objectFieldsView'] = function(options){
      ...
      _.each(o.value || {}, function(v, k){
        var vops = Belt.get(o, 'subschema.' + k) || {}
          , $child = Belt.get(o, 'child') || {}
          , $meth = vops.$method || vops.$meth || $child.$method || $child.$meth || 'mutableControl'
          , $opts = vops.$options || vops.$opts || $child.$options || $child.$opts || $child || {};

        $opts = Belt.extend({'value': v, 'name': k.toString()}, $child.$options || $child.$opts || $child, $opts);
    ...
    B['objectControl'] = function(options){
      ...
      , 'get': {
        ...
        , 'transformer': function(val){
            ...
            return !Belt.isEmpty(Belt.get(this, 'settings.schema')) ? Belt.objSchema(Belt.copy(v), this.settings.schema) : v;
          }
        }
      , 'views': {
          'objectHeaderView': B.objectHeaderView(Belt.extend(_.pick(o, ['removable', 'name', 'addable', 'child', 'schema']), o.header))
        , 'status': B.viewsArray({
                      'class': ['status']
      ...
      o.view.addPath = o.view.addPath || function(method, options){
        ...
        if (!Belt.isNull(_o.name)){
          ...
          , 'callback': function(name){
            ...
            $o = Belt.extend({}, $o, Belt.get(self, 'settings.subschemas.' + name) || {});
            method = method || _o.method || Belt.get($o, 'method') || Belt.get($o, 'meth');

            return self.setView(name, B[method](Belt.extend({'name': name}, $o, _o)));
          }});
        }
      };
      ...
      /*self.on('change', function(){
        self.set(self.get(), self.settings.schema, {'silent': true})
      });*/
    ...
    B['model'] = function(options){
      ...
      _o.set = function(path, val, opts){
        ...
        if (!o.silent && o.no_snapshot) var oa = this.attributes;
      ...
      _o.addView = function(name, _v, options){
        ...
        var container = _v.container
          , view = _v.$el ? _v : B[_v.method](Belt.extend({}, _v, {'schema': self.$schema}));
      ...
      _o.$conformSchema = function(){
        if (this.$schema){
          var _s = this.get()
            , _a = Belt.objSchema(Belt.copy(_s), this.$schema);
