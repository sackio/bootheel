...
(function(){
  ...
  var _$ = function(){
    ...
    B['model'] = function(options){
      ...
      _o.unset = function(path){
        var rt = {'oval': this.get(path), 'path': path};
      ...
      _o.splice = function(path, val, ind, rm){
        var ar = this.get(path)
          , o = options || {}
          , self = this;
        ...
        _.each(this.$views, function(v, k){
          if (rm) for (var i = 0; i < rm; i++) Belt.chain(v, ['getView', path], ['deleteView', ind]);
          Belt.chain(v, ['getView', path], ['push', val]);
          Belt.chain(v, ['getView', path], ['move', ar.length - 1, ind]);
          return;
        });
      ...
      _o.move = function(path, ind, dind){
        var ar = this.get(path)
          , o = options || {}
          , self = this;
